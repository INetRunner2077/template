...
<div id="search" class="search_bitrix">
<form action="" method="get" id="main-seach-bx">
...
<?else:?>
	<input type="text" class="form-control" placeholder="Поиск по названию" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" size="40" />
<?endif;?>
...
<?endif?>
    ...
    <button class="button-green" class="form-control" value="<?=GetMessage("SEARCH_GO")?>" type="submit"><span> Поиск</span></button>
</form><br />
